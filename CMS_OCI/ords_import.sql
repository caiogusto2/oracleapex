...
-- Schema: DEMO  Date: Tue Feb 18 10:01:43 2025 
--
...
BEGIN
   ...
   INSERT INTO APICALLAUX (
       ...
       v_tempid,   -- Ensure this matches the colum' || 'n data type
       v_uniqname, 
       v_file_name,
       v_extensao,
       v_tempdate,
   ...
   SELECT COUNT(*) INTO v_header_mis' || 'match
   FROM (
